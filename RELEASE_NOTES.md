...
Mastodon API: Tweaks to support the Subway Tooter app (contributed by pwilde), added support for editing posts, fixed an error related to the edit date of a post, fixed some crashes.
